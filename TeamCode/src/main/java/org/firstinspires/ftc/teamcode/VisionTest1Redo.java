...
public class VisionTest1Redo extends OpMode {
    ...
    public void init() {
        ...
        webcam.openCameraDeviceAsync(new AsyncCameraOpenListener() {
            public void onOpened() {
                ...
                webcam.startStreaming(streamWidth, streamHeight, OpenCvCameraRotation.UPRIGHT);
            }
    ...
    class zachpipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            Rect rect1 = new Rect(rect1X, rect1Y, streamWidth / 3 - 10, streamHeight - 10);
            Rect rect2 = new Rect(rect2X, rect2Y, streamWidth / 3 - 10, streamHeight - 10);
            Rect rect3 = new Rect(rect3X, rect3Y, streamWidth / 3 - 10, streamHeight - 10);
