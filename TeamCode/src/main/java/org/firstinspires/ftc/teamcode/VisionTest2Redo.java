    ...
    class BoundingBox extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            for(i = 0; i < contours.size(); ++i) {
                ...
                Imgproc.approxPolyDP(new MatOfPoint2f(((MatOfPoint)contours.get(i)).toArray()), contoursPoly[i], 3.0, true);
            ...
            for(i2 = 0; i2 < contours2.size(); ++i2) {
                ...
                Imgproc.approxPolyDP(new MatOfPoint2f(((MatOfPoint)contours2.get(i2)).toArray()), contoursPoly2[i2], 3.0, true);
                boundRect2[i2] = Imgproc.boundingRect(new MatOfPoint(contoursPoly2[i2].toArray()));
